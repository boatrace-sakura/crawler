...
use Boatrace\Venture\Project\MainCrawler;
...
{
    /**
     * @var \Boatrace\Venture\Project\MainCrawler
     */
    ...
    {
        $response = $this->crawler->program('2017-03-31', 24);
    ...
    {
        $response = $this->crawler->program('2017-03-31', null, 1);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
        $this->assertSame('おおむら桜祭り競走', $response->get('stadiums')->get(24)->get('races')->get(1)->get('title'));
    ...
    {
        $response = $this->crawler->program('2017-03-31', 24, 1);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
        $this->assertSame('おおむら桜祭り競走', $response->get('stadiums')->get(24)->get('races')->get(1)->get('title'));
    ...
    {
        $response = $this->crawler->notice('2017-03-31', 24);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
    ...
    {
        $response = $this->crawler->notice('2017-03-31', null, 1);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
        $this->assertSame(7, $response->get('stadiums')->get(24)->get('races')->get(1)->get('wind'));
    ...
    {
        $response = $this->crawler->notice('2017-03-31', 24, 1);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
        $this->assertSame(7, $response->get('stadiums')->get(24)->get('races')->get(1)->get('wind'));
    ...
    {
        $response = $this->crawler->result('2017-03-31', 24);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
    ...
    {
        $response = $this->crawler->result('2017-03-31', null, 1);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('technique_id'));
    ...
    {
        $response = $this->crawler->result('2017-03-31', 24, 1);
        $this->assertSame('2017-03-31', $response->get('stadiums')->get(24)->get('races')->get(1)->get('date'));
        $this->assertSame(24, $response->get('stadiums')->get(24)->get('races')->get(1)->get('stadium_id'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('race_number'));
        $this->assertSame(1, $response->get('stadiums')->get(24)->get('races')->get(1)->get('technique_id'));
    ...
    {
        $this->assertSame($this->stadiums, $this->crawler->stadium('2017-03-31')->all());
    }
    ...
    {
        $this->assertSame(array_keys($this->stadiums), $this->crawler->stadiumId('2017-03-31')->all());
    }
    ...
    {
        $this->assertSame(array_values($this->stadiums), $this->crawler->stadiumName('2017-03-31')->all());
    }
}
